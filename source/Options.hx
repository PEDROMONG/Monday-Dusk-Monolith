...
class LockWeeksOption extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.beatWeek0 = null;
		FlxG.save.data.beatWeek1 = null;
		FlxG.save.data.beatWeek2 = null;
		FlxG.save.data.beatWeek3 = null;
		confirm = false;
		trace('Weeks Locked');
		display = updateDisplay();
		return true;
...
class LyricDisplayOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.lyrics = !FlxG.save.data.lyrics;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Lyrics " + (!FlxG.save.data.lyrics ? "off" : "on");
	}
}
